...
def main():
    ...
    import os
    script_path = os.path.join(os.path.dirname(__file__), '..', 'scripts', 'new_grid_dca_183585926.py')
    spec = importlib.util.spec_from_file_location("new_grid_dca_183585926", script_path)
